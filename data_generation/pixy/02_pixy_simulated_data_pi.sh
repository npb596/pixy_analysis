...
#parallel '
#vcfslug=$(basename {})
#python ../../../../pixy/pixy/__main__.py --stats pi --vcf {} --window_size 10000 --populations populations_pi.txt --bypass_invariant_check yes --output_folder data/var_only/ --output_prefix ${vcfslug}' ::: ${vcfs[@]}
...
parallel '
vcfslug=$(basename {})
#if [ ! -s data/missing_sites/${vcfslug}_pi.txt ];
#then
python ../../../../pixy/pixy/__main__.py --stats pi --vcf {} --window_size 10000 --populations populations_pi.txt --bypass_invariant_check yes --output_folder data/missing_sites/ --output_prefix ${vcfslug}
#fi' ::: ${vcfs[@]}
...
parallel '
vcfslug=$(basename {})
python ../../../../pixy/pixy/__main__.py --stats pi --vcf {} --window_size 10000 --populations populations_pi.txt --bypass_invariant_check yes --output_folder data/missing_genos/ --output_prefix ${vcfslug}' ::: ${vcfs[@]}
#fi
